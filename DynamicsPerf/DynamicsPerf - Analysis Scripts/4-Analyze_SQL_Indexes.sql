...
WHERE  O.INDEX_DESCRIPTION NOT LIKE '%UNIQUE%' and O.INDEX_DESCRIPTION NOT LIKE 'CLUSTERED%'
...
WHERE
  ...
  (USER_SEEKS = 0 OR USER_SEEKS IS NULL)
  AND (USER_SCANS = 0 OR USER_SCANS IS NULL)
